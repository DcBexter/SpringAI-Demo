...
export class ModelService {
  ...
  getCurrentModelForConversation(conversationId: string): Observable<CurrentModelResponse> {
    return this.http.get<CurrentModelResponse>(
      `${this.apiUrl}/api/models/current?conversationId=${conversationId}`
    );
  }
